...
class VtopError_MenuUnavailable extends VtopError {
  const VtopError_MenuUnavailable(): super._();
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is VtopError_MenuUnavailable);
}
...
@override
String toString() {
  return 'VtopError.menuUnavailable()';
}
